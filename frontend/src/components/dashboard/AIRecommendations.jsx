...
function AIRecommendations({ trips = [] }) {
  ...
  const recommendations = [
    {
      ...
      description: `Your latest destination was ${destination}. Explore it again or discover similar places for your next vacation.`,
      ...
      <section className="rounded-3xl border border-secondary-200 bg-white p-6 shadow-card">
        ...
        <div className="mt-8 rounded-2xl bg-gradient-to-r from-primary-600 via-primary-500 to-accent-500 p-6 text-white">
          ...
          <p className="mt-3 leading-relaxed text-primary-50">
            Since you recently planned a trip to{" "}
            <span className="font-semibold">{destination}</span>, you may also
            enjoy exploring nearby destinations or revisiting during a different
            season for a completely new experience.
          </p>
