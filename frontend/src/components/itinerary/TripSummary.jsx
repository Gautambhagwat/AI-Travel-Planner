...
function TripSummary({ trip, heroImage }) {
  ...
  return (
      <section
          className="relative mb-8 overflow-hidden rounded-2xl p-5 text-white shadow-xl sm:mb-10 sm:rounded-3xl sm:p-8"
          style={{
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur sm:p-5">
              ...
              <h3 className="text-xl font-bold">
                {trip.tripName.replace(" AI Trip", "").replace(" Trip", "")}
              </h3>
            </div>
          </div>
        </div>
